...
export function Home() {
  ...
  const residentialImages = [
    "/embrace_roof%20panel.jpeg",
    "/embrace-solar-panel.jpeg",
  ];
  const commercialImages = ["/commercial.jpeg", "/commercial2.jpeg"];
  const maintenanceImages = ["/maintenance1.jpeg", "/maintenance2.jpeg"];
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <motion.div className="max-w-2xl" {...fadeIn}>
              ...
              <p className="text-slate-600 font-montserrat text-lg">
                ...
                Nigeria, Embrace Technologies delivers innovative, customized
                solar solutions designed to stand out and perform reliably. Our
                experienced technical team combines deep industry knowledge with
                practical expertise in the solar PV space to design, install,
                and maintain efficient power systems built for Nigerian
                conditions. From system design and execution to professional
                installation and ongoing maintenance, we provide end-to-end
                solar solutions that help homes and businesses enjoy stable,
                cost-effective, and long-lasting energy.
              </p>
            </motion.div>
            <motion.div {...fadeIn}>
              <Link
